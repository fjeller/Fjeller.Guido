...
/// <summary>
/// Command that inserts a new version 7 GUID at the current caret position in the editor.
/// </summary>
[VisualStudioContribution]
internal class InsertGuidV7Command : Command
{
	...
	public InsertGuidV7Command( TraceSource traceSource )
	{
...
#pragma warning disable CEE0027
	public override CommandConfiguration CommandConfiguration => new( "%InsertGuidV7Command.DisplayName%" );
#pragma warning restore CEE0027
	...
	public override async Task ExecuteCommandAsync( IClientContext context, CancellationToken cancellationToken )
	{
		...
		string newGuid = GuidHelper.CreateVersion7().ToString().ToUpper();
