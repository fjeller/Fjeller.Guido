...
internal class InsertLowercaseGuidV7Command : Command
{
	...
	public InsertLowercaseGuidV7Command( TraceSource traceSource )
	{
...
#pragma warning disable CEE0027
	public override CommandConfiguration CommandConfiguration => new( "%InsertLowercaseGuidV7Command.DisplayName%" );
#pragma warning restore CEE0027
	...
	public override async Task ExecuteCommandAsync( IClientContext context, CancellationToken cancellationToken )
	{
		...
		string newGuid = GuidHelper.CreateVersion7().ToString().ToLower();
